...
const UpdateWhatsAppService = ({ whatsappData, whatsappId }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { name, status, isDefault, session, greetingMessage, farewellMessage, queueIds = [], transferTicketMessage, startWorkHour, endWorkHour, startWorkHourWeekend, endWorkHourWeekend, outOfWorkMessage, monday, tuesday, wednesday, thursday, friday, saturday, sunday, defineWorkHours } = whatsappData;
    try {
