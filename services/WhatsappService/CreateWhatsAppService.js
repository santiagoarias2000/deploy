...
const CreateWhatsAppService = ({ name, status = "OPENING", queueIds = [], greetingMessage, farewellMessage, isDefault = false, isMultidevice, transferTicketMessage, startWorkHour, endWorkHour, daysOfWeek, startWorkHourWeekend, endWorkHourWeekend, outOfWorkMessage, monday, tuesday, wednesday, thursday, friday, saturday, sunday, defineWorkHours }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield schema.validate({ name, status, isDefault, isMultidevice });
    }
    catch (err) {
