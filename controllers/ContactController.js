...
const store = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield (0, CheckIsValidContact_1.default)(newContact.number);
    const validNumber = yield (0, CheckNumber_1.default)(newContact.number);
...
const update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield (0, CheckIsValidContact_1.default)(contactData.number);
    const { contactId } = req.params;
...
const list = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const contacts = yield (0, SimpleListService_1.default)({ name });
