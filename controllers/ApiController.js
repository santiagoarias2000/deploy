...
const createContact = (whatsappId, newContact) => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, CheckIsValidContact_1.default)(newContact);
    const validNumber = yield (0, CheckNumber_1.default)(newContact);
    const profilePicUrl = yield (0, GetProfilePicUrl_1.default)(validNumber);
    ...
    const createTicket = yield (0, FindOrCreateTicketService_1.default)({
...
const index = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (medias) {
        yield Promise.all(medias.map((media) => __awaiter(void 0, void 0, void 0, function* () {
            yield (0, SendWhatsAppMedia_1.default)({ body, media, ticket: contactAndTicket });
        })));
    }
    else {
        yield (0, SendWhatsAppMessage_1.default)({ body, ticket: contactAndTicket, quotedMsg });
    }
    return res.send();
});
exports.index = index;
